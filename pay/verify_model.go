...
func (v *VerifyResponse) LatestReceiptInfoOrderByExpiresDate() []*LatestReceiptInfo {
	return util.OrderBy[*LatestReceiptInfo, int64](v.LatestReceiptInfo, func(t *LatestReceiptInfo) int64 {
		dateTime, _ := t.PurchaseDateTime()
...
func (p *LatestReceiptInfo) ExpiresDateTime() (time.Time, error) {
	return util.MilliStrToTime(p.ExpiresDateTimestamp)
}
func (p *LatestReceiptInfo) PurchaseDateTime() (time.Time, error) {
	return util.MilliStrToTime(p.PurchaseDateTimestamp)
}
...
func (p *InApp) OriginalPurchaseDateTime() (time.Time, error) {
	return util.MilliStrToTime(p.OriginalPurchaseDateTimestamp)
}
